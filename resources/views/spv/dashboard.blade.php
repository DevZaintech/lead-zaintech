...
<div class="p-6 space-y-6">
    ...
    <div class="bg-white p-6 rounded-2xl shadow">
        <form method="GET" action="{{ route('dashboard.spv') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            <div>
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('dashboard.spv') }}" class="bg-gray-300 px-4 py-2 rounded-lg hover:bg-gray-400">
                    Reset
                </a>
            </div>
        </form>
