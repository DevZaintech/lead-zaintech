    ...
    @forelse ($lead as $item)
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-3">
            ...
            <div class="mt-4">
                ...
                @if($item->STATUS == 'lead' && $item->ID_USER == Auth::id())
                    <a href="{{ route('opportunity.create', ['lead_id' => $item->LEAD_ID]) }}"
                       class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 rounded">
                        Detail
                    </a>

                @elseif(in_array($item->STATUS, ['opportunity','lost','quotation','converted']) && $item->ID_USER == Auth::id())
