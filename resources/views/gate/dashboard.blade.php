...
<div class="p-6 space-y-6">
    ...
    {{-- Filter Tanggal + Sales --}}
    <div class="bg-white p-6 rounded-2xl shadow">
        <form method="GET" action="{{ route('dashboard.gate') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            <div>
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('dashboard.gate') }}" class="bg-gray-300 px-4 py-2 rounded-lg hover:bg-gray-400">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-6"> {{-- ubah ke 6 kolom biar muat --}}
        ...
        <div class="bg-yellow-400 text-black rounded-2xl p-6 shadow"> {{-- 👈 tambahan --}}
...
<script>
    ...
    // Bar Chart
    const barCtx = document.getElementById('barChart').getContext('2d'); // 👈 WAJIB ADA
    new Chart(barCtx, {
        type: 'bar',
        data: {
